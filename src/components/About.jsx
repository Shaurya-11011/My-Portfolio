      ...
      <div className="flex flex-col md:flex-row items-center gap-12">
        <div className="md:w-1/2">
          ...
          <p className="text-lg text-gray-300 mb-6">
            I’m a passionate full-stack developer with 3+ years of experience crafting digital experiences that users love. 
            I specialize in React, Node.js, and modern UI/UX design.
          </p>
